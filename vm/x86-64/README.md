...
No proof cost — direct native execution. Field arithmetic uses software
modular reduction on 64-bit integers. Performance depends on CPU clock
speed, cache hierarchy, and branch prediction. No metering or gas.
