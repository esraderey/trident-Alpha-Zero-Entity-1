...
- No high-level language — programs must be written in TASM (assembly) or use tasm-lib snippets. The Trident language (designed but not yet implemented) would address this.
