...
- Historically lacked a high-level language — programs had to be written in TASM (assembly) or use tasm-lib snippets. The Trident language now addresses this with a full compiler (43K lines of Rust, 740+ tests), type checker, cost analyzer, formatter, LSP, and formal verification tools.
...
| Maturity | **Implemented** (740+ tests, 43K LOC) | Production | Production | Production | Production | Early |
...
- [For Blockchain Devs](../tutorials/for-blockchain-devs.md) -- Mental model migration from smart contract platforms
