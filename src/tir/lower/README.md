...
|------|---------|-------------|
| [`mod.rs`](mod.rs) | Trait and factory | [`StackLowering`](mod.rs:17) trait, [`create_stack_lowering`](mod.rs:23) factory |
...
| [`tests.rs`](tests.rs) | Unit + comparison tests | per-backend tests, TIRBuilder+StackLowering vs [`Emitter`](../../legacy/emitter/mod.rs:30) comparison |
...
1. Create `new_target.rs` implementing [`StackLowering`](mod.rs:17) (one method: `fn lower(&self, ops: &[TIROp]) -> Vec<String>`)
2. Register in [`create_stack_lowering`](mod.rs:23)
